...
export default function CategoryCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ KEY FIX: Send raw base64 string directly — not an object
      // Backend will call uploadService.saveBase64Image(image, 'categories')
      // and return a full URL like http://localhost:5000/uploads/categories/xyz.jpg
      if (imageBase64) {
        categoryData.image = imageBase64; // pure base64 string
      }
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">Max 4 levels deep</p>
            </div>
