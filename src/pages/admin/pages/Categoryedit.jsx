  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-1">Update category details, image and SEO</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-3 pt-1">
              ...
              <div className="flex items-center gap-3">
                <label className="text-sm font-medium text-gray-700 w-28">Featured</label>
              ...
              {/* Active */}
              <div className="flex items-center gap-3">
                <label className="text-sm font-medium text-gray-700 w-28">Active</label>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    name="isActive"
